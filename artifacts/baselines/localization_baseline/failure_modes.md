...
- The supervised baseline currently outperforms the first semi-supervised run on the labeled subset: lower mean normalized error, higher PCK, and much lower temporal jitter.
