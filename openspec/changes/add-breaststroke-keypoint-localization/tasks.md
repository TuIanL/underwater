...
- [ ] 4.1 Generate pseudo-labels on unlabeled breaststroke clips using confidence thresholds from the supervised baseline
- [x] 4.2 Add semi-supervised training support for confidence-gated pseudo-labels and augmentation-consistency losses
- [ ] 4.3 Experiment with temporal consistency or smoothing constraints after the single-frame baseline is stable
...
- [ ] 5.1 Package the best checkpoint, schema definition, and evaluation report as the project's localization baseline
